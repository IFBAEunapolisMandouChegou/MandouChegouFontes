...
import br.edu.ifba.eunapolis.disunity.mandouchegou.jpa.session.VeiculoFacade;
...
public class VeiculoController implements Serializable {
    ...
    @EJB
    private br.edu.ifba.eunapolis.disunity.mandouchegou.jpa.session.VeiculoFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/resources/Bundle").getString("VeiculoCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/resources/Bundle").getString("VeiculoUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/resources/Bundle").getString("VeiculoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
