...
import br.edu.ifba.eunapolis.disunity.mandouchegou.jpa.session.ItemPedidoFacade;
...
public class ItemPedidoController implements Serializable {
    ...
    @EJB
    private br.edu.ifba.eunapolis.disunity.mandouchegou.jpa.session.ItemPedidoFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/resources/Bundle").getString("ItemPedidoCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/resources/Bundle").getString("ItemPedidoUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/resources/Bundle").getString("ItemPedidoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public ItemPedido getItemPedido(java.lang.Long id) {
