...
import br.edu.ifba.eunapolis.disunity.mandouchegou.jpa.session.PessoaFacade;
...
public class PessoaController implements Serializable {
    ...
    @EJB
    private br.edu.ifba.eunapolis.disunity.mandouchegou.jpa.session.PessoaFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/resources/Bundle").getString("PessoaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/resources/Bundle").getString("PessoaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/resources/Bundle").getString("PessoaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
