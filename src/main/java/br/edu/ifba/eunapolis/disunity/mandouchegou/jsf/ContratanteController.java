...
import br.edu.ifba.eunapolis.disunity.mandouchegou.jpa.session.ContratanteFacade;
...
public class ContratanteController implements Serializable {
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/resources/Bundle").getString("ContratanteCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/resources/Bundle").getString("ContratanteUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/resources/Bundle").getString("ContratanteDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Contratante getContratante(java.lang.Long id) {
